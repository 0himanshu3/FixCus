...
// Explicitly load the API key and add a check for its existence
const API_KEY = process.env.GEMINI_API_KEY;
if (!API_KEY) {
  // Updated error message to reflect the correct file path
  throw new Error("GEMINI_API_KEY is not defined in your config/config.env file.");
}

// Initialize the Google AI client with the validated API key
