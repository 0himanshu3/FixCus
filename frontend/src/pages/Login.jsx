...
function Login() {
    ...
    return (
        <div className="flex flex-col justify-center md:flex-row h-screen relative overflow-hidden">
            ...
            <motion.div
                className="w-full md:w-1/2 flex items-center justify-center p-4 sm:p-6 md:p-8 relative z-10"
                initial="initial"
                animate="animate"
                exit="exit"
                variants={leftVariants}
            >
                <div className="w-full max-w-md bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 border-4 border-purple-200">
                    {/* Header with emoji */}
                    <div className="text-center mb-4 sm:mb-6">
                        <div className="inline-block bg-gradient-to-r from-blue-400 to-purple-500 text-white text-2xl sm:text-3xl md:text-4xl p-3 sm:p-4 rounded-full mb-3 sm:mb-4 shadow-lg">
                            🎯
                        </div>
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
                            Welcome Back!
                        </h3>
                        <p className="text-gray-600 font-medium text-sm sm:text-base">Sign in to continue your journey</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-3 sm:space-y-4">
                        ...
                        <div>
                            <input
                                ...
                                className="w-full px-3 sm:px-4 py-2 sm:py-3 border-3 border-purple-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-200 focus:border-purple-500 transition-all placeholder-gray-400 text-sm sm:text-base"
                            />
                        </div>
