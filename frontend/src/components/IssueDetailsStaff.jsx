...
                                        <div>
                                        {/* --- MODIFICATION START --- */}
                                            <button
                                                className={`px-3 py-1 rounded-md text-white ${isAssigning || assignModalOpen || isResolved ? "bg-gray-400 cursor-not-allowed" : "bg-blue-500"
                                                    }`}
                                                onClick={() => {
                                                    if (isAssigning || assignModalOpen || isResolved) return; // prevent multiple clicks
...
                                        <div>
                                        {/* --- MODIFICATION START --- */}
                                            <button className={`px-3 py-1 text-white rounded-md ${isResolved ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500'}`}
                                                onClick={() => {
...
                        <div className="flex gap-2">
                                {/* --- MODIFICATION START --- */}
                            <button className={`px-3 py-1 text-white rounded-md ${isResolved ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-500'}`}
